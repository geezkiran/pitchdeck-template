  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-6 text-center">
        <HeadingBlock size="xl" className="max-w-[90rem] text-foreground">
          From{" "}
          ...
          <span className="text-foreground">bookings</span> to a{" "}
          <span className="text-foreground">continuous</span>{" "}
          <span className="text-accent">health relationship.</span>
        </HeadingBlock>
      </div>
    </Slide>
  );
